...
PROTOBUF_NAMESPACE_OPEN
template<> ::masterworker::PingRequest* Arena::CreateMaybeMessage<::masterworker::PingRequest>(Arena*);
template<> ::masterworker::PingResponse* Arena::CreateMaybeMessage<::masterworker::PingResponse>(Arena*);
...
class PingRequest PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:masterworker.PingRequest) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "masterworker.PingRequest";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:masterworker.PingRequest)
 private:
  class _Internal;
...
class PingResponse PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:masterworker.PingResponse) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "masterworker.PingResponse";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:masterworker.PingResponse)
 private:
  class _Internal;
